...
namespace Billycock.Migrations
{
    ...
    [Migration("20210911013109_Cambio de fecha Default")]
    partial class CambiodefechaDefault
    {
            ...
            modelBuilder.Entity("Billycock.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("fechaInscripcion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
                        .HasDefaultValueSql("CAST(CAST(GETUTCDATE() AS DATETIMEOFFSET) AT TIME ZONE 'CENTRAL STANDARD TIME (MEXICO)' AS DATETIME)");
